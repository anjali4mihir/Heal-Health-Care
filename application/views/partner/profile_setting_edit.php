<?php 
//echo "<pre>";
//print_r($profile_records->open_timing);exit;
?>
                    ...
                    <form class="form" method="post" id="form" name="form" action="" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-t-40 row">
							...
							<div class="<?php if($time_id=='1'){ ?>  d-none <?php } ?>" id="CustomTimingDiv">
								<?php if(isset($profile_records->open_timing) && !empty($profile_records->open_timing))
                                {
                                    $timedata=json_decode($profile_records->open_timing,true);
                                    //echo "<pre>";print_r($timedata);exit;
                                }?>
                                <div class="col-md-12 pull-left">
									<div class="row">
										<div class="col-md-3">
											<input <?php if(isset($timedata[0]) && $timedata[0]['Day']=="Monday"){echo "checked";}?> type="checkbox" id="mon" name="days" value="Monday"> Monday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">
											<input <?php if(isset($timedata[1]) && $timedata[1]['Day']=="Tuesday"){echo "checked";}?>  type="checkbox" id="tue" name="days" value="Tuesday"> Tuesday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">&nbsp;</div>
										<div class="col-md-3">
											<input <?php if(isset($timedata[2]) && $timedata[2]['Day']=="Wednesday"){echo "checked";}?>  type="checkbox" id="wed" name="days" value="Wednesday"> Wednesday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">&nbsp;</div>
										<div class="col-md-3">
											<input <?php if(isset($timedata[3]) && $timedata[3]['Day']=="Thursday"){echo "checked";}?>  type="checkbox" id="thu" name="days" value="Thursday"> Thursday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">
											<input <?php if(isset($timedata[4]) && $timedata[4]['Day']=="Friday"){echo "checked";}?>  type="checkbox" id="fri" name="days" value="Friday"> Friday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">&nbsp;</div>
										<div class="col-md-3">
											<input <?php if(isset($timedata[5]) && $timedata[5]['Day']=="Saturday"){echo "checked";}?>  type="checkbox" id="sat" name="days" value="Saturday"> Saturday
										</div>
										<div class="col-md-3">
										...
										<div class="col-md-3">&nbsp;</div>
										<div class="col-md-3">
											<input <?php if(isset($timedata[6]) && $timedata[6]['Day']=="Sunday"){echo "checked";}?>  type="checkbox" id="sun" name="days" value="Sunday"> Sunday
										</div>
										<div class="col-md-3">
                        ...
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-3 col-md-3 col-sm-3 col-form-label">Authorized Signature<span class="error">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-3 col-md-3 col-sm-3 col-form-label">Contact
                            <span class="error">*</span></label>
                            <div class="col-md-9">
                                <input class="form-control" type="number" name="contact_no" id="v" placeholder="Enter contact" value="<?php echo $profile_records->contact_no; ?>" > 
                            </div>
                        </div>
...
<script>
    $(function() {
        ...
        rules: {
            ...
            contact_no: {required:true,number:true,minlength:10,maxlength:10},
            profile: {extension: "jpg|jpeg|png"},
            stamp: {extension: "jpg|jpeg|png"},
            symbol : {extension: "jpg|jpeg|png"},
            pancard : {extension: "jpg|jpeg|png"},
            "store_image[]" : {extension: "jpg|jpeg|png"},
        },
        messages: {
            ...
            contact_no: {required:"Please enter contact no",number:"Please enter contact no"},
            profile: {extension: "Image Extension Must be jpg|jpeg|png"},
            stamp: {extension: "Image Extension Must be jpg|jpeg|png"},
            symbol : {extension: "Image Extension Must be jpg|jpeg|png"},
            pancard : {extension: "Image Extension Must be jpg|jpeg|png"},
            "store_image[]" : {extension: "Image Extension Must be jpg|jpeg|png"},
        },
