                    ...
                    <div class="row">
                        <div class="col-lg-7 m-auto">
                            <div class="page-title-content content-style5 text-center">
                                <p><font color="#ed1c24">@</font>Heal App</p>
                                    ...
                                    <div id="tab-1" class="tab-content current">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="name">Enter <?php if($rowd->category != 1 ) { echo 'Lab' ;}else{'Store' ;} ?>Name<span class="error">*</span></label>
                                                    <input type="text" class="form-control" placeholder="Enter  Name" id="storename" name="storename" required>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" class="form-control" placeholder="Enter Google Map Link" id="map_link" name="map_link" required>
                                                ...
                                                <div class="col-md-6 d-none" id="amountDiv">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="amount" id="amount" class="form-control"
                                                            onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" placeholder="Enter Amount" required>
                                        ...
                                        <div class="row d-none" id="CustomTimingDiv">
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" id="end_mon" name="end_mon"><br>
                                                <input type="checkbox" id="tue" name="tue" value="Tuesday">
                                                <label for="monday"> Tue.</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pan" name="pan"
                                                        maxlength="10" minlength="10" placeholder="Enter PAN"
                                                        required />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="adharcard_no"
                                                        name="adharcard_no" maxlength="12" minlength="12"placeholder="Enter Adhaar Card No" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter GSTIN"
                                                        id="gstin" name="gstin" maxlength="15" minlength="15" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter Licence No" id="licence_no" name="licence_no" <?php if($rowd->category == 1){ echo 'required';}
													?>>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="qualification" class="form-control"
                                                        id="qualification" placeholder="Qualification" <?php if($rowd->category == 1){ echo 'required';} ?>>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Name of College" id="UG_college"
                                                            name="UG_college" <?php if($rowd->category != 1){ echo 'required';}?>>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Name of University" id="UG_uni" name="UG_uni" <?php if($rowd->category != 1){ echo 'required';}?>>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">&nbsp;</label>
                                                        <select name="UG_year" id="UG_year" class="form-control" <?php if($rowd->category != 1){ echo 'required';}?>></select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Name of MCI" id="UG_MCI" name="UG_MCI" <?php if($rowd->category != 1){ echo 'required';} ?>>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">&nbsp;</label>
                                                        <select name="UG_MCI_year" id="UG_MCI_year" class="form-control" <?php if($rowd->category != 1){ echo 'required';} ?>></select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="gstin_certificate" name="gstin_certificate" required />
                                                    <p class="p-error" id="gstin_certificate_error"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="name">Upload Sign-Board<span class="error">*</span></label>
                                                    <input type="file" class="form-control" id="sign_board" name="sign_board" required />
                                                    <p class="p-error" id="sign_board_error"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="name">Upload Images Of <?php if($rowd->category == 1){ echo 'Store';} else{echo 'Lab'; } ?> (min 3 - max 5)(optional)</label>
                                                    <input type="file" class="form-control" id="store_image"
                                                        name="store_image[]" multiple />
                                                    <p class="p-error" id="store_image_MAXerror" style="display:none;">Upload Max 5 Files allowed </p>
                                                    <p class="p-error" id="store_image_MINerror" style="display:none;">Upload Min 3 Files allowed </p>
                                                </div>
                                            </div>
                                            <?php if($rowd->category == 1){ ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="name">Upload B.PHARM/M.PHARM Licence<span class="error">*</span></label>
                                                    <input type="file" class="form-control" id="bpharm_lience" name="bpharm_lience" required />
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="name">Upload degree Certificate<span class="error">*</span></label>
