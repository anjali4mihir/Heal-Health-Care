                ...
                <div class="full_width contact-us">
                    ...
                    <form class="form" method="post" id="form" name="form" action="" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group m-t-40 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="title" id="title" placeholder="Enter Title" value="<?= $speciality_records->title; ?>"> 
                            </div>
                        </div>
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Details
                                <span class="error">*</span></label>
                            <div class="col-md-10">
                                <textarea class="form-control" type="text" name="details"><?= $speciality_records->details?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-field col s12">
                                 <input type="checkbox" id="indeterminate-checkbox" name="status" class="js-switch" <?php echo ($speciality_records->status=='1')? "checked" : ""; ?> autocomplete="off"/>
                            </div>
                        </div>
                        <div class="form-group row">
