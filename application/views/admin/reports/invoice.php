  ...
  <body>
    ...
    <div class="price-table">
      <table class="table" cellspacing="0" cellpadding="0">
        <thead>
          ...
          <?php } ?>
            ...
            <?php } ?>
            <th scope="col" style="width:7%;text-align:left;">MRP</th>
            <th scope="col" style="width:7%;text-align:left;">CGST</th>
            <th scope="col" style="width:7%;text-align:left;">CGST Amt.</th>
            <th scope="col" style="width:7%;text-align:left;">SGST</th>
            <th scope="col" style="width:7%;text-align:left;">SGST Amt.</th>
            <th scope="col" style="width:7%;text-align:left;">DI %</th>
            <th scope="col" style="width:7%;text-align:left;">DI Amt.</th>
            <th scope="col" style="width:7%;text-align:left;">Amount</th>
          </tr>
        </thead>
        <tbody>
          <?php 
        ...
        // echo "</pre>";
         ?>
          <tr>
            	...
            	<td><?php if(isset($row['name']) && !empty($row['name'])){ ?><?= strtoupper($row['name']); ?><?php } ?></td>
      ...
      <div style="width:100%;position:relative">
        <div class="note" style="width:300px;padding-top:100px;float:left;">
    ...
    <div class="main-tankyou">
      ...
      <div class="tankyou-two-logo">
        <img src="<?php echo $symbolpath.$pharmcydata['symbol']; ?>" alt="demo" height="50px" width="50px" style="text-align:center;margin:auto;margin-left:50px;">
      ...
      <div class="tankyou-two-logo">
        <img src="<?php echo $stamppath.$pharmcydata['stamp']; ?>" alt="demo" height="50px" width="50px" style="text-align:center;margin:auto;margin-left:50px;">
       
      </div>


      <div class="thankyou">
        <h5><?php echo $pharmcydata['return_policy']; ?></h5>
      </div>
      <div class="tankyou-two-logo">
        <img src="<?= base_url() ?>assets\img\logo.png" alt="demo" height="50px" width="50px" style="text-align:center;margin:auto;margin-left:50px;">
