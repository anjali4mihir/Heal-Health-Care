                ...
                <div class="full_width contact-us">
                    ...
                    <form class="form" method="post" id="form" name="form" action="" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group m-t-40 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="name" id="name"placeholder="Enter Name" value="<?= $records->name; ?>"> 
                            </div>
                        </div>
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Email<span class="error">*</span></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="email" id="email" placeholder="Enter Email" value="<?= $records->email; ?>">
                            </div>
                        </div>
                        <div class="form-group m-t-40 row">
                            <label class="col-lg-2 col-md-2 col-sm-2 col-form-label">Mobile No<span class="error">*</span></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="mobile" id="mobile" placeholder="Enter Mobile" value="<?= $records->contactno; ?>"></div>
                        </div>
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">User Name<span class="error">*</span></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="username" id="username"placeholder="Enter User Name" value="<?= $records->username; ?>"> 
                            </div>
                        </div>
                        <div class="form-group m-t-40 row">
                            <label class="col-lg-2 col-md-2 col-sm-2 col-form-label">Password<span class="error">*</span></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="password" id="password" placeholder="Enter Password" value="<?= $records->org_password; ?>"></div>
                        </div>
                        <div class="form-group m-t-40 row" id="ModulList">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="user" value="1" <?php if(in_array('1',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">Tools Management</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="category" value="2" <?php if(in_array('2',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox2">CMS Pages Management</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="music" value="3" <?php if(in_array('3',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox3">Register Partner Management</label>
                                </div> 
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="video" value="4" <?php if(in_array('4',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox2">Patients Management</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="banner" value="5" <?php if(in_array('5',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox2">Report Management</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="ads" value="6" <?php if(in_array('6',$module_array)){echo 'checked';} ?>>
                                    <label class="form-check-label" for="inlineCheckbox2">Partner's Inventory Management</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="ads" value="7" <?php if(in_array('7',$module_array)){echo 'checked';} ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <img src="<?php echo $returnpath.$records->image; ?>" id="image" class="img-thumbnail" height="100" width="100" />
                            </div>
                        </div>
