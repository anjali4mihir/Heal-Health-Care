            ...
            <div class="tab-content" id="myTabContent" >
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="full_width network-btn-main">
                        <a href="<?= base_url().'message_languages/add' ?>" class="add-post-btn add-company-btn float-right"><i class="fa fa-plus"></i>Add</a>
                    </div>  
                        ...
                        <table id="example23" class="example table table-striped table-bordered table-data-load" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Message<br>(english)</th>
                                    <th scope="col">Message<br>(hindi)</th>
                                    <th scope="col">Message Key</th>
                                    <th scope="col">Actions On <br> English Message</th>
                                    <th scope="col">Actions On <br> Hindi Message</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php if(count($messageList) > 0) {
                                ...
                                $edit_url_english = base_url() . 'message_languages/edit_english/' . $value['engid'];
                                $edit_url_hindi = base_url() . 'message_languages/edit_hindi/' . $value['hindiid'];
                                $delete_url_english = base_url() . 'message_languages/delete/' . $value['engid'].'?hid='.$value['hindiid'];?>
                                <tr>
                                    <td><?php echo $rowno; ?></td>
                                    <td><?php echo $value['engtitle']; ?></td>
                                    <td><?php echo $value['hindititle']; ?></td>
                                    <td><?php echo $value['message_key']; ?></td>
                                    <td>
