                ...
                <div class="full_width contact-us">
                   ...
                   <form class="form" method="post" id="form" name="form" action="" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Message
                        ...
                        <?php if($hindi_records[0]['parent_id'] == 0){ ?>
                         <div class="form-group m-t-40 row">
                            <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Message Key
                                <span class="error">*</span></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="message_key" id="message_key" placeholder="Enter message Key"
                                 value="<?php echo $hindi_records[0]['message_key'];?>"> 
                            </div>
                        </div>
                        <?php } ?>
    ...
    $(function() {
        $("#form").validate({
         rules: {
            ...
            message_key: {
                required:true,
                remote: {
                    url: "<?php echo base_url(); ?>message_languages/Register_message_edit",
                    type: "POST",
                    data: {
                        id: '<?php echo $hindi_records[0]['id'];?>'
                            }
                    }
            }
        },
        messages: {
            message: {
                ...
                remote: "message is already register",
            },
        },
