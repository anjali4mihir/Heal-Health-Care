                    ...
                    <form class="form" method="post" id="form" name="form" action="" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-t-40 row">
                            ...
                            <div class="input-field col s12">
                                 <input type="checkbox" id="indeterminate-checkbox" name="status" class="js-switch" <?php echo ($test_records['status']=='1')? "checked" : ""; ?>  autocomplete="off"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <a href="<?= base_url().'inventory/provisional' ?>" class="btn btn-primary">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    $(function() {
        ...
        rules: {
            name: {
                required:true,
                remote:{
                    url: "<?php echo site_url("check_provisional_edit_test_exist_or_not"); ?>",
                    type: "POST",
                    data: {
