        ...
        <div class="full_width searchby-truck-main my-ratings my-network">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                    <a class="nav-link <?php if($inventory_type == 'drugmedicine'){echo 'active';} ?>" id="drugmedicine-tab" href="<?= base_url().'inventory/drugmedicine' ?>" role="tab" aria-controls="drugmedicine" aria-selected="false">Dr. MEDICINE (<?= $drug_medicines_list ?>)</a></li>
            ...
            <div class="tab-content mt-5" id="myTabContent">
               ...
               <div class="tab-pane fade show <?php if($inventory_type == 'pharmacy'){echo 'active';} ?>" id="medicine" role="tabpanel" aria-labelledby="medicine-tab">
                ...
                <div class="tab-pane fade show <?php if($inventory_type == 'provisional'){echo 'active';} ?>" id="provisionaltest" role="tabpanel" aria-labelledby="provisionaltest-tab">
                 ...
                 <div class="tab-pane fade show <?php if($inventory_type == 'drugmedicine'){echo 'active';} ?>" id="drugmedicine" role="tabpanel" aria-labelledby="drugmedicine-tab">
                    <div class="full_width network-btn-main">
                        <a href="<?= base_url().'inventory/add_drug_medicine' ?>" class="add-post-btn add-company-btn float-right"><i class="fa fa-plus"></i>Add</a>
                    ...
                    <div class="full_width all_tables table-responsive rating-table load-table"> 
                        ...
                        <table id="example27" class="example table table-striped table-bordered table-data-load" style="width:100%">
                            <thead>
                                <tr>
                                    <th scope="col">
                                        <input id="chk_all" name="chk_all" type="checkbox" />
...
$(document).ready( function () {
    ...
    if(inventory_type=="drugmedicine" || inventory_type=="drugmedicine")
    {
        $('#example27').DataTable({
            "processing": true,
            "language": {
            ...
            "serverSide": true,
            "ajax": {
                url: "<?=base_url('inventory/inventory_drug_medicines');?>",
                type: "POST",
                data: {
                    token: hash
                }
