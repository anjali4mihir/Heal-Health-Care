        ...
        <div class="col-sm-12">
            <nav aria-label="breadcrumb" class="mt-22">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url().'vendors/list/pending';?>">Vendors </a></li>
								...
								<table class="table table-hover table-bordered detail-view">
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%"><?php if($data['category'] == 1 || $data['category'] == 2 || $data['category'] == 3){ echo $storedata->owner_name;}else {echo $storedata->name; } ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%"><?= date("d-m-Y", strtotime($storedata->dob)); ?></td>
                                        </tr>
                        ...
                        <?php } ?>
                            <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td width="75%"><?php if($storedata->charges != ''){echo 'Yes';}  ?></td>
                                </tr>
                                <tr>
                                    <th scope="row" width="25%"><strong>Charges</strong></th>
                                    
                                    <td width="75%"><?php if($storedata->charges == 'Amount'){echo number_format((float)$storedata->amount , 2, '.', '');}else{ echo 'Free';}  ?></td>
                                </tr>
                                <?php } ?> 
                                <?php
                                ...
                                <tr>
                                    ...
                                    <td width="75%"><?= $storedata->gstin; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <?php if($storedata->pan != ''){ if($storedata->is_valid_gstin == 0){?> 
								...
								<?php if($data['status_by_admin'] == 0 ){ ?>    
									<?php if($data['is_fill_profile'] == 1 ){ ?>
                                        ...
                                        <?php } 
                                            ...
                                            <?php if($documents_status->pancard == 1 && $documents_status->ug_certificate == 1 && $documents_status->ug_mci_certificate == 1 && $documents_status->sign_board == 1 && $documents_status->gstin_certificate == 1 && $documents_status->gstin_certificate == 1 && ($storedata->is_valid_aadhar_no == 1 || $storedata->is_valid_pan == 1)){ ?>
                                                <a  href="<?php echo base_url().'vendors/changeStatus/'.$data['id'].'?status='.'1';?>" class="mt-3 btn btn-success btn-sm">Approve</a>
                                            <?php } ?>
                                        <?php } else{ ?> 
                                            <?php if($documents_status->pancard == 1 && $documents_status->degree_certificate == 1 && $documents_status->bpharm_licence == 1 && $documents_status->sign_board == 1 && $documents_status->gstin_certificate == 1 && $documents_status->gstin_certificate == 1 && ($storedata->is_valid_aadhar_no == 1 || $storedata->is_valid_pan == 1)){ ?>
                                                <a  href="<?php echo base_url().'vendors/changeStatus/'.$data['id'].'?status='.'1';?>" class="mt-3 btn btn-success btn-sm">Approve</a>
                                            <?php } ?>
                                        <?php } ?>
                                    <?php } ?>
