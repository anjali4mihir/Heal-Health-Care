            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="full_width network-btn-main">
                        <a href="<?= base_url().'testimonials/add' ?>" class="add-post-btn add-company-btn float-right"><i class="fa fa-plus"></i>Add</a>
                    </div>  
                    <div class="full_width all_tables table-responsive rating-table load-table">                
                        ...
                        <div class="alert alert-success alert-dismissible" role="alert" id="myElem" style="display:none">
                            ...
                            <strong>Success !</strong> Testimonials activated successfully.
                        </div>
                        <div class="alert alert-danger alert-dismissible" role="alert" id="myElemNo"  style="display:none">
                            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <strong>Success !</strong> Testimonials deactivated successfully. 
                        </div>
                            ...
                            <?php
                                if (count($testimonials) > 0) {
                                    ...
                                    foreach ($testimonials as $category) {
                                        $edit_url = base_url() . 'testimonials/edit/' . $category->id;
                                        $delete_url = base_url() . 'testimonials/delete/' . $category->id;?>  
                                        <tr>
                                            <td>
                                            ...
                                            <td><input type="checkbox" class="js-switch tgl_checkbox"  data-table="tbl_testimonials" data-status="status" data-idfield="id"  data-id="<?php echo $category->id; ?>" id='cb_<?php echo $category->id; ?>'  <?php echo ($category->status == '1') ? "checked" : ""; ?> /></td>
                                            <td>
