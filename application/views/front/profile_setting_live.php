                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 mb-3">
                                                <label class="radio-inline">
                                                    <input type="radio" name="optradio" id="optradio" value="1" checked>Google Address
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="optradio" value="2" id="optradio">Manually address
                                                </label>
                                            </div>
                                            <div class="col-md-12" id="manual_address">
                                                <div class="form-group">
                                                    <label for="name">Enter Your Address<span class="error">*</span></label>
                                                    <input type="text" class="form-control" placeholder="Enter Address" id="location" name="location">
