...
<body>
    ...
    <div class="doctor-detail find-doctor-detail">
        <div class="container">
            <img class="animation-element fadeLeft animation-element-exslow" src="<?= base_url(); ?>assets/img/find-doctor.png" alt="Animal Doctor">
        </div>
    </div>

    <div class="consultant-section">
        <div class="container">
            <img class="animation-element fadeRight animation-element-exslow" src="<?= base_url(); ?>assets/img/doctor-consultanat-img.png" alt="Doctor Services"> 
        </div>
    </div>

    <div class="video-section animation-element zoom animation-element-exslow">
        <div class="container">
            <iframe width="560" height="500" src="https://www.youtube.com/embed/EwOifk5TE2Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
