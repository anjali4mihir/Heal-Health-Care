...
<body>
    ...
    <div class="doctor-detail lab-detail">
        <div class="container">
            <h2 class="animation-element fadeRight animation-element-slow"> Now Book Lab Test From  <br/> <span> Your Choice of Lab With Ease </span></h2>
            <img class="animation-element fadeLeft animation-element-exslow" src="<?= base_url(); ?>assets/img/lab-detail-img.png" alt="Animal Doctor">
        </div>
    </div>

    <div class="consultant-section">
        <div class="container">
            <img class="animation-element fadeRight animation-element-exslow" src="<?= base_url(); ?>assets/img/lab-detail-btm.png" alt="Doctor Services"> 
        </div>
    </div>

    <div class="video-section animation-element zoom animation-element-exslow">
        <div class="container">
            <iframe width="560" height="500" src="https://www.youtube.com/embed/yPNCWY8nr_k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
