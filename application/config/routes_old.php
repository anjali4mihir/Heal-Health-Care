...
$route['pending-sample-collect'] = "orders/order/7";
$route['sample-collected'] = "orders/order/3";
$route['pending-report'] = "orders/order/8";
$route['deliverd-report'] = "orders/order/4";
$route['requests/cancelled-request'] = "orders/order/5";
$route['requests/rejected-request'] = "orders/order/6";
$route['requests/pending-request'] = "orders/order/1";
$route['requests/accepted-request'] = "orders/order/2";
$route['pending-appointment'] = "orders/order/7";
$route['appointment-completed'] = "orders/order/3";
$route['pending-report'] = "orders/order/8";
$route['deliverd-report'] = "orders/order/4";
$route['requests/cancelled-request'] = "orders/order/5";
$route['requests/rejected-request'] = "orders/order/6";
...
$route['check_test_exist_or_not_master'] = 'inventory/check_test_exist_or_not';
$route['check_edit_test_exist_or_not_master'] = 'inventory/check_edit_test_exist_or_not';
$route['check_radio_test_exist_or_not_master'] = 'inventory/check_radio_test_exist_or_not';
$route['check_radio_edit_test_exist_or_not_master'] = 'inventory/check_radio_edit_test_exist_or_not';
$route['check_provisional_test_exist_or_not_master'] = 'inventory/check_provisional_test_exist_or_not';
$route['check_provisional_edit_test_exist_or_not_master'] = 'inventory/check_provisional_edit_test_exist_or_not';

$route['test-modality'] = 'radiologyservices/modality';
