...
class Api extends CI_Controller
{
    ...
    public function update_visit_status()
    {
        ...
        $authtoken = isset($_REQUEST['authtoken']) ? $_REQUEST['authtoken'] : "";
        $currendeviceid = isset($_REQUEST['currendeviceid']) ? $_REQUEST['currendeviceid'] : "";
        $clinic_visit_status = isset($_REQUEST['clinic_visit_status']) ? $_REQUEST['clinic_visit_status'] : "";
    ...
    public function add_my_availability() {
        ...
        if(count($data_or_not)>0){
            $this->checkemptyvalue('', $this->get_message_value_from_key($language_id, 'date_already_exist'));
            exit;
        } else {
    ...
    public function add_single_my_availability() {
        ...
        if($save_or_not == 1) {
            ...
            return $this->sendResponse([], $this->get_message_value_from_key($language_id,'date_time_already_exist'));
            exit;
        }
    }
