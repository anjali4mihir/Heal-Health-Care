...
class Api extends CI_Controller
{
       ...
       // print_r($data);die;
        ...
        if(count($data) > 0) {
            ...
            if($data[0]['category'] = 4){
               ...
               $patientNotificationTitle = 'Pending Request';
            ...
            $patientnotification_insert = [
                        ...
                        "description"       => count($data)."  Accepted Your Request. View Details.",//Number of ".$categoryLabel.
                        "temp_appointment_data"=>$temp_appointment_data,
                        "request_id"        => $random_no,
                        "created_at"        => date('Y-m-d H:i:s')
                    ];
            ...
            $patientnotification_message['body'] = count($data)."  Accepted Your Request. View Details.";
    ...
    public function accept_or_reject_reqest()
    {
        ...
        if($status == '1' || $status == 1){
            ...
            if($category_type == 4 || $category_type == 5){
                ...
                $Message = "Your '".$ConsultationType."' Consultation With ".$senderRecord->name." Has Been Confirmed"; 
            }else{
                if($is_reinitate == 1){
    ...
    public function medicine_order()
    {
        ...
        if (strtoupper($response->status) == 'CAPTURED' || strtoupper($response->status) == 'AUTHORIZED') {
            ...
            $notification_insert = [
                ...
                "description"   => "Your Medicine Order-".$customorder_id." Has Been Created",
                "request_id"    => "",
            ];
            $this->notification_entery($notification_insert);
            ...
            if($notification_insert)
            {
                ...
                $notification_patient_message['body'] = "Your Medicine Order-".$customorder_id." Has Been Confirmed";
    ...
    public function book_appoitment()
    {
        ...
        if (strtoupper($response->status) == 'CAPTURED' || strtoupper($response->status) == 'AUTHORIZED') {
            ...
            if($notification_insert)
            {
                ...
                if($appoitmentRecord->consulation_type != 1){
                    $isOnline = 'Onlline';
                }else{
                    $isOnline = 'Home';
                }
    ...
    public function appoitment_change_status()
    {
        ...
        if ($appointment_status == 1) {
            ...
            if($category_type == 4 || $category_type == 5){
                $message_response = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Completed. You Have Period Of 7 days For Follow up.";
                $message = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Completed. You Have Period Of 7 days For Follow up.";
                $title = 'Completed Consultation';
            }else{
                $message_response = "Your ".$ConsultationType." Service With ".$appoitmentRecord->partner_name." Has Been Completed. You Have Period Of 7 days For Follow up.";
                $message = "Your ".$ConsultationType." Service With ".$appoitmentRecord->partner_name." Has Been Completed. You Have Period Of 7 days For Follow up.";
            ...
            if($category_type == 4 || $category_type == 5){
                $message_response = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Cancelled By ".$appoitmentRecord->partner_name." For ".$reason."";
                $message = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Cancelled By ".$appoitmentRecord->partner_name." For ".$reason."";
                $title = 'Cancelled Consultation';
            }else{
                $message_response = "Your ".$ConsultationType." Service With ".$appoitmentRecord->partner_name." Has Been Cancelled By ".$appoitmentRecord->partner_name." For ".$reason."";
                $message = "Your ".$ConsultationType." Service With ".$appoitmentRecord->partner_name." Has Been Cancelled By ".$appoitmentRecord->partner_name." For ".$reason."";
                $title = 'Cancelled Service';
            }
            
        } else if ($appointment_status == 4) {
            $message_response = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Cancelled By You  For ".$reason."";
            $message = "Your ".$ConsultationType." Consultation With ".$appoitmentRecord->partner_name." Has Been Cancelled By You  For ".$reason."";
    ...
    public function generatePaymentcumInvoice($orderId)
    {
        ...
        if($orderdata['consulation_type']==0)
        {
            $final['consulation_type']='Video Consultation';
        }
        else if($orderdata['consulation_type']==1)
        {
            $final['consulation_type']='Home Consultation';
        }
        else
        {
        ...
        if($orderdata['consulation_type']==0)
        {
            $final['consulation_name']='Video Consultation';
        }
        else if($orderdata['consulation_type']==1)
        {
            $final['consulation_name']='Home Consultation';
        }
        else
        {
