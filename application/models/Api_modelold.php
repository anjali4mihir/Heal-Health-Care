...
class Api_model extends CI_Model
{
    ...
    public function get_medicine_by_id($id,$partnerId) {
        $q = $this->db->query("SELECT * FROM `tbl_store_wise_medicines` LEFT JOIN tbl_medicine ON tbl_medicine.id=tbl_store_wise_medicines.medicine_id  WHERE tbl_store_wise_medicines.medicine_id = '" . $id . "'AND tbl_store_wise_medicines.partner_id = '" . $partnerId . "' limit 1");
        return $q->row_array();
    }
    ...
    public function get_pharmcy_store($medicine,$medicineqty,$latitude,$longitude,$is_homesample,$timing_wiseCount)
    {
        ...
        for($i = 0; $i < count($medicine); $i++){
           ...
           $query = "SELECT GROUP_CONCAT(partner_id)as partner_id FROM `tbl_store_wise_medicines` WHERE medicine_id = '".$medicine[$i]."' AND stock >= '".$medicineqty[$i]."' AND tbl_store_wise_medicines.partner_id IN ($timing_wiseCount)";
           $row = $this->db->query($query)->row_array();
           if(!empty($row['partner_id']) || $row['partner_id'] != ''){
                array_push($finalarray,explode(',',$row['partner_id']));
           }
        }
        //print_r(count($finalarray));die;
        $result_partners = 0;
        if(!empty($finalarray)){
        ...
        if($is_homesample == 1)
        {
            $query1 = "SELECT id,tbl_partners.store_name,tbl_partners.email,tbl_partners.contact_no,tbl_partners.address,tbl_partners.address,tbl_partners.city,tbl_partners.state,tbl_partners.country,(SELECT name FROM tbl_countries WHERE id=tbl_partners.country) as country_name ,(SELECT name FROM tbl_states WHERE id=tbl_partners.state) as state_name ,(SELECT name FROM tbl_cities WHERE id=tbl_partners.city) as city_name ,tbl_partners.latitude,tbl_partners.longitude,tbl_partners.delivery_charge as delivery_charge,111.045 * DEGREES(ACOS(COS(RADIANS('".$latitude."')) * COS(RADIANS(tbl_partners.latitude)) * COS(RADIANS(tbl_partners.longitude) - RADIANS('".$longitude."')) + SIN(RADIANS('".$latitude."')) * SIN(RADIANS(tbl_partners.latitude)))) as distance_in_km,is_homesample,open_timing FROM tbl_partners WHERE tbl_partners.id IN ($result_partners) AND `is_homesample`='".$is_homesample."' ";   
        }else{
            $query1 = "SELECT tbl_partners.id,tbl_partners.store_name,tbl_partners.email,tbl_partners.contact_no,tbl_partners.address,tbl_partners.address,tbl_partners.city,tbl_partners.state,tbl_partners.country,(SELECT name FROM tbl_countries WHERE id=tbl_partners.country) as country_name ,(SELECT name FROM tbl_states WHERE id=tbl_partners.state) as state_name ,(SELECT name FROM tbl_cities WHERE id=tbl_partners.city) as city_name ,tbl_partners.latitude,tbl_partners.longitude,tbl_partners.delivery_charge as delivery_charge,111.045 * DEGREES(ACOS(COS(RADIANS('".$latitude."')) * COS(RADIANS(tbl_partners.latitude)) * COS(RADIANS(tbl_partners.longitude) - RADIANS('".$longitude."')) + SIN(RADIANS('".$latitude."')) * SIN(RADIANS(tbl_partners.latitude)))) as distance_in_km,is_homesample FROM tbl_partners WHERE tbl_partners.id IN ($result_partners) ";
        }
    ...
    public function get_pathology($test,$latitude,$longitude,$is_homesample,$timing_wiseCount)
    {
        ...
        if($is_homesample == 1)
        {
            $query1 = "SELECT id,tbl_partners.store_name,open_timing,tbl_partners.email,tbl_partners.contact_no,tbl_partners.address,tbl_partners.address,tbl_partners.city,tbl_partners.state,tbl_partners.country,(SELECT name FROM tbl_countries WHERE id=tbl_partners.country) as country_name ,(SELECT name FROM tbl_states WHERE id=tbl_partners.state) as state_name ,(SELECT name FROM tbl_cities WHERE id=tbl_partners.city) as city_name ,tbl_partners.latitude,tbl_partners.longitude,(SELECT sum(sale_price) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_sale_amount,(SELECT sum(mrp) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_taxable_amount ,(SELECT sum(discount) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_discount_amount,(SELECT sum(gst) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_gst_amount,(SELECT sum(total) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_total_amount,tbl_partners.delivery_charge as delivery_charge,111.045 * DEGREES(ACOS(COS(RADIANS('".$latitude."')) * COS(RADIANS(tbl_partners.latitude)) * COS(RADIANS(tbl_partners.longitude) - RADIANS('".$longitude."')) + SIN(RADIANS('".$latitude."')) * SIN(RADIANS(tbl_partners.latitude)))) as distance_in_km,is_homesample FROM tbl_partners WHERE tbl_partners.id IN ($result_partners) AND `is_homesample`='".$is_homesample."'";   
        }else{
            $query1 = "SELECT tbl_partners.id,tbl_partners.store_name,tbl_partners.email,tbl_partners.contact_no,tbl_partners.address,tbl_partners.address,tbl_partners.city,tbl_partners.state,tbl_partners.country,(SELECT name FROM tbl_countries WHERE id=tbl_partners.country) as country_name ,(SELECT name FROM tbl_states WHERE id=tbl_partners.state) as state_name ,(SELECT name FROM tbl_cities WHERE id=tbl_partners.city) as city_name ,open_timing,tbl_partners.latitude,tbl_partners.longitude,tbl_partners.delivery_charge as delivery_charge,(SELECT sum(sale_price) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_sale_amount,(SELECT sum(mrp) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_taxable_amount ,(SELECT sum(discount) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_discount_amount,(SELECT sum(gst) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_gst_amount,(SELECT sum(total) FROM tbl_test_pathology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_total_amount,111.045 * DEGREES(ACOS(COS(RADIANS('".$latitude."')) * COS(RADIANS(tbl_partners.latitude)) * COS(RADIANS(tbl_partners.longitude) - RADIANS('".$longitude."')) + SIN(RADIANS('".$latitude."')) * SIN(RADIANS(tbl_partners.latitude)))) as distance_in_km,is_homesample FROM tbl_partners WHERE tbl_partners.id IN ($result_partners) ";
        }
        return $this->db->query($query1)->result_array();
    }
    ...
    public function get_radiology($test,$latitude,$longitude,$timing_wiseCount)
    {
        ...
        //print_r($test_ids);die;
            $query1 = "SELECT tbl_partners.id,tbl_partners.store_name,tbl_partners.email,tbl_partners.contact_no,tbl_partners.address,tbl_partners.address,tbl_partners.city,tbl_partners.state,tbl_partners.country,(SELECT name FROM tbl_countries WHERE id=tbl_partners.country) as country_name ,(SELECT name FROM tbl_states WHERE id=tbl_partners.state) as state_name ,(SELECT name FROM tbl_cities WHERE id=tbl_partners.city) as city_name ,open_timing,tbl_partners.latitude,tbl_partners.longitude,tbl_partners.delivery_charge as delivery_charge,(SELECT sum(sale_price) FROM tbl_report_radiology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_sale_amount,(SELECT sum(mrp) FROM tbl_report_radiology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_taxable_amount ,(SELECT sum(discount) FROM tbl_report_radiology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_discount_amount,(SELECT sum(gst) FROM tbl_report_radiology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_gst_amount,(SELECT sum(total) FROM tbl_report_radiology_wise WHERE partner_id=tbl_partners.id AND test_id IN ($test_ids)) as total_total_amount,111.045 * DEGREES(ACOS(COS(RADIANS('".$latitude."')) * COS(RADIANS(tbl_partners.latitude)) * COS(RADIANS(tbl_partners.longitude) - RADIANS('".$longitude."')) + SIN(RADIANS('".$latitude."')) * SIN(RADIANS(tbl_partners.latitude)))) as distance_in_km,is_homesample FROM tbl_partners WHERE tbl_partners.id IN ($result_partners) ";
    ...
    public function get_consultation($category,$partner_id,$consultation_type,$appointment_status,$is_follow)
    {
        if($category != 5){
